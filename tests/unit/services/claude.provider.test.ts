...
import { ClaudeProvider } from '@infrastructure/services/llm/claude.provider';
...
describe('ClaudeProvider', () => {
  ...
  describe('chat', () => {
    ...
    it('应该在 API 错误时抛出错误', async () => {
      ...
      const messages = [{ role: 'user', content: 'Hello' }];
      await expect(provider.chat(messages, {})).rejects.toThrow('Claude API');
    });
  });
